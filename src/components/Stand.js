        ...
        <div className="stand_parent">
            <Container>
                <Grid container>
                    ...
                    <Grid container className="stand_card_parent">
                        <Grid item container xs={12} sm={6} md={4} className="stand_card stand_right_line">
                            <div>
                                <img
                        ...
                        <Grid container item xs={12} sm={6} md={4} className="stand_card stand_right_line">
                            <img
                        ...
                        <Grid item container xs={12} sm={6} md={4} className="stand_card">
                            <img
